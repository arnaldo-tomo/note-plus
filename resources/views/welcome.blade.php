                            ...
                            <ul id="otherpage" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                <li class="">
                                    ...
                                    <ul id="user" class="iq-submenu collapse" data-parent="#otherpage">
                                        <li class="">
                                            <a href="https://templates.iqonic.design/note-plus/html/app/user-profile.html"
                                                class="svg-icon">
                                                <i class="">
                                        ...
                                        <li class="">
                                            <a href="https://templates.iqonic.design/note-plus/html/app/user-add.html"
                                                class="svg-icon">
                                                <i class="">
                                        ...
                                        <li class="">
                                            <a href="https://templates.iqonic.design/note-plus/html/app/user-list.html"
                                                class="svg-icon">
                                                <i class="">
