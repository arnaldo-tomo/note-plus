                                        ...
                                        <div class="form-group">
                                            ...
                                            <div id="icon-button">
                                                <button class="btn btn-outline-primary ml-1 active" type="button"
                                                    data-change="click" wire:model="icon" data-custom-target="#note-icon">
                                ...
                                <div class="col-md-4" id="default">
                                    <div class="card card-block card-stretch card-height card-bottom-border-info note-detail"
                                        ...
                                        <div class="card-body rounded">
                                            <h4 class="card-title text-ellipsis short-1" id="note-title">Example Note
                                            </h4>
                                            <p class="mb-3 text-ellipsis short-6" id="note-description">Lorem Ipsum is
