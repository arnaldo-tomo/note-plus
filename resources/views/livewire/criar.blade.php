...
@endif
                                                    ...
                                                    <label class="form-check-label" for="inlineRadio4">
                                                        <a class="btn btn-outline-primary ml-1" data-change="click"
                                                            ...
                                                            <svg width="23" class="svg-icon"
                                                                ...
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-width="2"
                                                                    d="M21 15.546c-.523 0-1.046.151-1.5.454a2.704 2.704 0 01-3 0 2.704 2.704 0 00-3 0 2.704 2.704 0 01-3
                                                                     0 2.704 2.704 0 00-3 0 2.704 2.704 0 01-3 0 2.701 2.701 0 00-1.5-.454M9 6v2m3-2v2m3-2v2M9 3h.01M12 3h.01M15 3h.01M21 21v-7a2 2 0 00-2-2H5a2 2 0 00-2 2v7h18zm-3-9v-2a2 2 0 00-2-2H8a2 2 0 00-2 2v2h12z" />
                                                            </svg>
                                                        </a>
                                                    </label>
                                                </div>
                                ...
                                <div class="col-md-4" id="default">
                                    <div class="card card-block card-stretch card-height card-bottom-border-danger py-3 note-detail"
                                        ...
                                        <div class="card-header d-flex justify-content-between">
                                            ...
                                            <div class="icon iq-icon-box-2 icon-border-danger py-3 rounded"
                                                id="note-icon">
                                        ...
                                        <div class="card-footer">
                                            <div
                                                ...
                                                <a href="#" class=""><i
                                                        class="las la-user-friends mr-2 font-size-20"></i>Apenas Eu</a>
                                                <a href="#" class=""><i
            ...
            <div class="default-note py-3 d-none">
                <div class="card card-block card-stretch card-height py-3 card-bottom-border-{{ $priority }} note-detail"
                    id="update-note">
                    <div class="card-header d-flex justify-content-between py-3">
                        <div class="icon iq-icon-box-2 py-3 icon-border-{{ $priority }} rounded" id="note-icon">
                            <svg width="23" class="svg-icon py-3" id="iq-main-01"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        ...
                        <div class="card-header-toolbar py-3 d-flex align-items-center">
                            <div class="dropdown">
                                <span class="dropdown-toggle dropdown-bg" id="dropdownMenuButton4"
                                    data-toggle="dropdown" aria-expanded="false" role="button">
                                    <i class="ri-more-fill"></i>
                    ...
                    <div class="card-footer">
                        <div
                            class="d-flex align-items-center py-3 justify-content-between note-text note-text-{{ $priority }}">
                            <a href="#" class=""><i
